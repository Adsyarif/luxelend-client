...
//       try {
//         const response = await axios.get('http://127.0.0.1:5000/women/product');
//         console.log('Response:', response.data);

//         if (Array.isArray(response.data.women_products) && response.data.women_products.length > 0) {
//           let filteredProducts = response.data.women_products;
